...
public class CardViewNationAdapter extends RecyclerView.Adapter<CardViewNationAdapter.CardViewViewHolder> {
    ...
    public CardViewNationAdapter(Context context) {
    ...
    public CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_cardview_nation, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull CardViewViewHolder cardViewViewHolder, int i) {
        ...
        cardViewViewHolder.btnFavorite.setOnClickListener(new CustomOnItemClickListener(i, new CustomOnItemClickListener.OnItemClickCallback() {
            ...
            public void onItemClicked(View view, int position) {
                Toast.makeText(context, "Favorite "+getListNation().get(position).getName(), Toast.LENGTH_SHORT).show();
            }
        }));
        cardViewViewHolder.btnShare.setOnClickListener(new CustomOnItemClickListener(i, new CustomOnItemClickListener.OnItemClickCallback() {
            @Override
            public void onItemClicked(View view, int position) {
                Toast.makeText(context, "Share "+getListNation().get(position).getName(), Toast.LENGTH_SHORT).show();
            }
        }));
    }
